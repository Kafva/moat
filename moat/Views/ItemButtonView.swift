...
struct ItemButtonView: View {
    ...
    init(
        unread_count: Binding<Int>, unread: Binding<Bool>, video_id: Int,
        rssurl: String, screenWidth: CGFloat,
        apiWrapper: ApiWrapper<ServerResponse>
    ) {
    ...
    var body: some View {
        ...
        Button(action: {
            ...
            ZStack {
                ...
                RoundedRectangle(cornerRadius: 15, style: .continuous)
                    ...
                    .frame(
                        width: self.screenWidth
                            * BUTTON_WIDTH_PERCENTAGE_OF_ROW,
                ...
                .foregroundColor(
                    unread ? Color.white : Color.white.opacity(0.5))
            }
        }
    }
}
